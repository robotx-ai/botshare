...
- Providers can access only their own service-management endpoints and incoming-booking data.
- Providers cannot manage services or bookings they do not own.
- Admin authorization is controlled by `ADMIN_EMAILS` allowlist and overrides ownership limits.
